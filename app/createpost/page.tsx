...
export default function CreatePost() {
   // Md editor Dark Mode
    ...
    console.log("Session in component:", currentSession);
    // Instantiate Router
                ...
                <div className="my-10 space-y-6">
                    ...
                    <div className="flex flex-col space-y-1">
                        ...
                        <div className="bg-gray-100 rounded-sm p-2" data-color-mode={theme === 'dark' ? 'dark' : 'light'} onDragOver={(e) => e.preventDefault()} onDrop={HandleContentImgDrop}>
                            <MDEditor value={content} onChange={setContent} preview="edit" height={600} textareaProps={{placeholder: 'Enter Markdown text...'}}
